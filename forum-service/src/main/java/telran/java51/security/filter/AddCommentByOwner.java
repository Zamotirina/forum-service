...
@Order(60)
public class AddCommentByOwner implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		String postId = array[array.length-3];
	...
	private boolean checkEndPoint(String method, String servletPath) {
		return HttpMethod.PUT.matches(method)  &&  servletPath.matches("/forum/post/\\w+/comment/\\w+");
	}
}
